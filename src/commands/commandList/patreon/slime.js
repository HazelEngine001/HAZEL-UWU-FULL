...
const emoji = '<a:slime:770111215493316638>';
...
module.exports = new CommandInterface({
	...
	desc: 'Give a slime to someone! You can only gain one if you receive it! This command was created by ?403989717483257877?',
...
async function give(p, user) {
	...
	p.send(`${emoji} **| ${user.username}**, ${p.getName()} gave you 2 ${plural}!`);
}
