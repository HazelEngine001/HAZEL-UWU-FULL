...
const emoji = '<a:donut:737165800275968010>';
...
module.exports = new CommandInterface({
	...
	desc: 'Give donuts to someone! You can only gain one if you receive it! This command was created by ?575555630312456193?',
...
async function give(p, user) {
	...
	p.send(
		`${emoji} **| ${
			user.username
		}**, ${p.getName()} sent you 2 donuts to dunk in your coffee <a:coffee:737166368125878312>`
	);
}
