...
async function addPerk(p, id) {
	...
	await patreonUtil.giveCustomWeapon(p, id);

	// Send msgs
	const user = await p.sender.msgUser(
		id,
		`${emoji} **|** You received the ability to customize your **weapon** command!\n${p.config.emoji.blank} **|** You can customize it in our website: https://owobot.com/user/customize/weapon`
	);
