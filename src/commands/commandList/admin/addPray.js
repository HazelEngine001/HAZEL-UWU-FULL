...
async function addPerk(p, id) {
	...
	await patreonUtil.giveCustomPray(p, id);

	// Send msgs
	const user = await p.sender.msgUser(
		id,
		`${emoji} **|** You received the ability to customize your **pray** and **curse** command!\n${p.config.emoji.blank} **|** You can customize it in our website: https://owobot.com/user/customize/pray`
	);
